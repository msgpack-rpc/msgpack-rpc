...
public class MultiThreadServerTest extends TestCase {
    @Test    
    ...
    */
    ...
    class ClientTask implements Runnable {
        ...
        protected final MultiThreadServerTest t;
        public ClientTask(Client c, MultiThreadServerTest t) {
            this.c = c;
            this.t = t;
        }
    ...
    protected void testRPC(Client c, ServerMock sm) throws Exception {  
        ...
        for (int i = 0; i < nthread; i++)
            es.execute(new ClientTask(c, this));
