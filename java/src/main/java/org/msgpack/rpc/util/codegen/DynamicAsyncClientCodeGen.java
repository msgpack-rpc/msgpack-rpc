...
class DynamicAsyncClientCodeGen extends DynamicClientCodeGenBase {
    private static Logger LOG = LoggerFactory
            .getLogger(DynamicAsyncClientCodeGen.class);

    @Override
    protected CtClass makeClass(String handlerName) throws NotFoundException {
        StringBuilder sb = new StringBuilder();
        sb.append(handlerName);
        sb.append(POSTFIX_TYPE_NAME_ASYNCCLIENT);
        sb.append(inc());
    ...
    private void insertHandlerMethodBody(StringBuilder sb, Method method, int i) {
        // org.msgpack.rpc.Future f = _$$_client.callAsyncApply("m0", $args);
        ...
        if (!c.equals(void.class)) {
            ...
            sb.append(String.format(STATEMENT_CLIENT_CALLASYNCAPPLY_01, args0));
            ...
            Object[] args0 = new Object[] { VARIABLE_NAME_CLIENT,
                    method.getName() };
            sb.append(String.format(STATEMENT_CLIENT_CALLASYNCAPPLY_02, args0));
        }
